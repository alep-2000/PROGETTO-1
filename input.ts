...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const printResults = document.getElementById('results')as HTMLDivElement;
    

calculate.addEventListener('click', function(){
    const input1 = document.getElementById('input_1')as HTMLInputElement;
    const input2 = document.getElementById('input_2')as HTMLInputElement;
    const operator = document.getElementById('operators')as HTMLSelectElement;
